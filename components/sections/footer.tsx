        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <a
                  href="mailto:b.design2111@gmail.com"
                  className="text-foreground/70 hover:text-foreground transition-colors"
                >
                  b.design2111@gmail.com
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-3">
              <a
                ...
                className="w-9 h-9 rounded-full border border-foreground/20 flex items-center justify-center hover:bg-foreground hover:text-background transition-all"
